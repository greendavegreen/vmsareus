"""
Django settings for vmsareus project.
...
ALLOWED_HOSTS = ['vmsareus.lebanon.cd-adapco.com', 'vmsareus', '127.0.0.1']
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'vmsareus.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Dave Green""", 'david.green@cd-adapco.com'),
]
...
LOGIN_REDIRECT_URL = 'leases:vm_list'
